...
@Deprecated
public abstract class BaseActivity1<T extends BasePresent<AppCompatActivity>> extends MVPBaseActivity<T,AppCompatActivity> implements View.OnClickListener {
     ...
     * @param resid
     */
    public void shpwRightTvColor(int resid)
    {
