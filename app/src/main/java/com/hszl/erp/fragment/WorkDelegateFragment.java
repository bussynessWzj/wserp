...
public class WorkDelegateFragment extends MVPBaseFragment<WorkPresent,WorkConstract.IWorkView>
        implements WorkConstract.IWorkView ,SwipeRefreshLayout.OnRefreshListener {
