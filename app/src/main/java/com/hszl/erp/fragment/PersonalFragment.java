...
import com.hszl.erp.present.PersonalPresent;

import java.util.ArrayList;
import java.util.List;

public class PersonalFragment extends MVPBaseFragment<PersonalPresent,PersonalContract.IPersonalView> implements
   PersonalContract.IPersonalView,BaseQuickAdapter.OnItemClickListener {
    ...
    @Override
    protected PersonalPresent creatPresent(MVPBaseFragment<PersonalPresent, PersonalContract.IPersonalView> personalPresentIPersonalViewMVPBaseFragment) {
